...
<head>
    ...
    <title>Gerard Krijgsman</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootswatch/4.4.1/litera/bootstrap.min.css" integrity="sha384-pLgJ8jZ4aoPja/9zBSujjzs7QbkTKvKw1+zfKuumQF9U+TH3xv09UUsRI52fS+A6" crossorigin="anonymous">
    ...
    <div class="my-3">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="https://rpguru.com/">RPGuru</a> <a href="https://github.com/ghdpro/rpguru" class="text-secondary"><i class="fab fa-github"></i></a></h5>
                        <p class="card-text">
                            Database voor dual audio (Engels & Japans) RPG games. Geschreven in Python &amp; Django web framework.
                            In de toekomst wil ik het mogelijk maken om à la Wikipedia iedereen content aan de site te laten toevoegen.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="https://github.com/ghdpro/django-changerequest">django-changerequest</a> <a href="https://github.com/ghdpro/django-changerequest" class="text-secondary"><i class="fab fa-github"></i></a></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="https://github.com/ghdpro/django-artwork">django-artwork</a> <a href="https://github.com/ghdpro/django-artwork" class="text-secondary"><i class="fab fa-github"></i></a></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="https://pypi.org/project/django-template-toolkit/">django-template-toolkit</a> <a href="https://github.com/ghdpro/django-template-toolkit" class="text-secondary"><i class="fab fa-github"></i></a></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="https://animesuki.com/">AnimeSuki</a> <em class="text-secondary">(gesloten)</em></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="http://imagehost.org/">ImageHost.org</a> <em class="text-secondary">(gesloten)</em></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><a href="http://fanzub.com/">fanzub</a> <em class="text-secondary">(gesloten)</em> <a href="https://github.com/fanzub/fanzub" class="text-secondary"><i class="fab fa-github"></i></a></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><span class="text-secondary">Checkspam.net</span> <em class="text-secondary">(gesloten)</em></h5>
                        <p class="card-text">
                            Deze site was bedoeld als een API voor het snel checken van een IP of email adres om te zien
                            of deze was opgenomen in bepaalde spam databases. Was geschreven in Python &amp; Django web framework.
                        </p>
                    </div>
                </div>
            </div>
